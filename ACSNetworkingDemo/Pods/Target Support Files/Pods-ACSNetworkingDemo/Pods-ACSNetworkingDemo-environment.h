...
// ACSNetworking
#define COCOAPODS_POD_AVAILABLE_ACSNetworking
#define COCOAPODS_VERSION_MAJOR_ACSNetworking 0
#define COCOAPODS_VERSION_MINOR_ACSNetworking 0
#define COCOAPODS_VERSION_PATCH_ACSNetworking 1
